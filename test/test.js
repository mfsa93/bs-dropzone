...
describe("Dropzone", function () {
  ...
  describe("constructor()", function () {
    ...
    return describe("options", function () {
      ...
      it('should add a clickable element if addMore == true', function() {
        dropzone = new Dropzone(element, {addMore: true})
        return dropzone.clickableElements.includes(dropzone.addMore); 
      });
